...
export default function TabServ() {
            ...
            <TabPanel value={value} index={0}>
              {/*loading ? (
                ...
                <Grid container spacing={3}>
                  {/*data.allItemServiceCategories.length ? (
                    data.allItemServiceCategories.map(itemcategory => <ItemCategory itemcategory={itemcategory} key={itemcategory.id} slugcat={itemcategory.slugcat} items={itemcategory.items}/>)
                  ) : (
                  ) : (
