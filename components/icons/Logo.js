...
const KeystoneJSLogo = (props) => {
  return (
    <svg viewBox="0 0 220 220" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
...
KeystoneJSLogo.propTypes = {};

export default KeystoneJSLogo;
